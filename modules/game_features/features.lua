...
controller:registerEvents(g_game, {
    onClientVersionChange = function(version)
        ...
        -- g_game.enableFeature(GameWingsAurasEffectsShader) -- DISABLED: server doesn't send wings/auras/effects/shader data
        ...
        -- g_game.enableFeature(GameCreatureShader) -- DISABLED: server doesn't send creature shader data
        -- g_game.enableFeature(GameCreatureAttachedEffect) -- DISABLED: server doesn't send attached effect data
        ...
        if version >= 910 then
            ...
            -- g_game.enableFeature(GameItemShader) -- DISABLED: server doesn't send item shader data
        end
