...
function BTCCaveBot.checkRecording()
  ...
  if currentPos.z ~= BTCCaveBot.lastRecordedPos.z then
    -- Adiciona posicao anterior como USE
    BTCCaveBot.addWaypoint(BTCCaveBot.WaypointTypes.USE, 
      BTCCaveBot.lastRecordedPos.x, 
      BTCCaveBot.lastRecordedPos.y, 
      BTCCaveBot.lastRecordedPos.z)
    -- Adiciona nova posicao como WALK
    BTCCaveBot.addWaypoint(BTCCaveBot.WaypointTypes.WALK, currentPos.x, currentPos.y, currentPos.z)
    BTCCaveBot.lastRecordedPos = currentPos
    BTCCaveBot.updateWaypointCount()
    return
